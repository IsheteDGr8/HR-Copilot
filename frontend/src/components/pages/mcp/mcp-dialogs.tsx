          ...
          <button
            ...
            className={
              row.secret
                ...
                : "flex h-9 shrink-0 items-center gap-1 rounded-md border border-border/60 bg-white px-2 text-[11px] font-medium text-muted-foreground transition-colors hover:border-border"
            }
        ...
        {authMethod === "OAuth 2.0" && (
          <>
            <div className="flex items-center justify-between gap-3 rounded-lg border border-border/60 bg-secondary/30 px-4 py-3">
              ...
              {oauthConnected ? (
                <span className="flex shrink-0 items-center gap-1 rounded-md border border-success/30 bg-success/10 px-2 py-1 text-[11px] font-medium text-success">
