...
const statusTone = {
  ...
  draft: "bg-navy/10 text-navy border-navy/30",
...
export default function AutomationsPage() {
  ...
  return (
    <PageContainer>
      ...
      <div className="dream-in grid gap-3 md:grid-cols-2 xl:grid-cols-3">
        {automations.map((a) => {
          ...
          return (
            <article
              key={a.id}
              className="flex flex-col rounded-xl border border-border/60 bg-white p-5 transition-colors duration-150 hover:border-border hover:bg-secondary/50"
            >
      ...
      {creating && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#16233A]/45 p-4 backdrop-blur-sm">
