    ...
    <div className="flex flex-col gap-4">
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <h3 className="mt-0.5 truncate text-[15px] font-semibold text-neutral-50">{name}</h3>
        ...
        <button
          ...
          className="inline-flex h-8 items-center gap-1.5 rounded-md border border-white/10 bg-white/[0.04] px-2 text-[11px] text-neutral-300 disabled:opacity-40"
        >
          ...
          return (
            <li key={step.key}>
              <button
                ...
                className="flex w-full items-center justify-between gap-3 rounded-lg border border-white/[0.07] bg-white/[0.02] px-3 py-2.5 text-left transition-colors enabled:hover:bg-white/[0.05] disabled:cursor-not-allowed disabled:opacity-60"
              >
                <div className="flex min-w-0 items-center gap-2">
                  ...
                  <span className="truncate text-[13px] text-neutral-100">{step.label}</span>
                </div>
      ...
      {empId ? (
        <p className="text-[11px] text-neutral-500">Click any item to toggle its status.</p>
      ) : null}
