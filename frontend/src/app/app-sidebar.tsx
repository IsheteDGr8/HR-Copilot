      ...
      <div className="px-3 pb-2">
        <div className="flex items-stretch gap-1">
          <Button
            variant="secondary"
            onClick={goNewChat}
            className="btn-3d btn-glow flex-1 justify-center gap-2 rounded-md border border-black/10 bg-gradient-to-br from-[#1F4E79] to-[#173D5F] font-medium text-white shadow-xl transition-all hover:from-[#245D91] hover:to-[#1F4E79]"
          >
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                ...
                className="btn-3d btn-glow group rounded-md border border-black/10 bg-gradient-to-br from-[#1F4E79] to-[#173D5F] text-white shadow-xl transition-all hover:from-[#245D91] hover:to-[#1F4E79]"
              >
